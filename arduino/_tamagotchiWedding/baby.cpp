...
void CBaby::drawFacePart(char my_array[])
{
  ...
  for (int index = 0 ; index < 33 ; index++)
    CLcd5110::LcdWrite(LCD_D, my_array[index]);
  CLcd5110::gotoXY(27, 3);
  for (int index = 0 ; index < 33 ; index++)
    CLcd5110::LcdWrite(LCD_D, my_array[33 + index]);
  CLcd5110::gotoXY(27, 4);
  for (int index = 0 ; index < 33 ; index++)
    CLcd5110::LcdWrite(LCD_D, my_array[33*2 + index]);
  CLcd5110::gotoXY(27, 5);
  for (int index = 0 ; index < 33 ; index++)
    CLcd5110::LcdWrite(LCD_D, my_array[33*3 + index]);
}
...
void CBaby::drawPoop()
{
  ...
  for (int index = 0 ; index < 10 ; index++)
    CLcd5110::LcdWrite(LCD_D, poopImg[index]);
  CLcd5110::gotoXY(0, 4);
  for (int index = 0 ; index < 10 ; index++)
    CLcd5110::LcdWrite(LCD_D, poopImg[109 + index]);
  CLcd5110::gotoXY(0, 5);
  for (int index = 0 ; index < 10 ; index++)
    CLcd5110::LcdWrite(LCD_D, poopImg[10*2 + index]);
  CLcd5110::gotoXY(0, 6);
  for (int index = 0 ; index < 10 ; index++)
    CLcd5110::LcdWrite(LCD_D, poopImg[10*3 + index]);
}
